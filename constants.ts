...
export const TOURS_DATA: Tour[] = [
  {
    ...
    summary: [
      ...
      { text: "From NZ$14,990", className: "text-lg font-semibold text-center text-alpine-green mt-4" },
  ...
  },
  {
    ...
    summary: [
      ...
      { text: "From NZ$20,990", className: "text-lg font-semibold text-center text-alpine-green mt-4" },
      { text: " per person (twin share).", className: "text-md italic text-center text-alpine-green" },
    ],
    heroImage: getImagePath("black_forest_gat.jpg"),
    route: "/tours/cake",
    price: "From NZ$20,990",
